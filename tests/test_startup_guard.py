"""test_startup_guard.py — permanent CI defense for PLT-002.
...
Run in CI alongside the isolation test — and, per the integration gate, also in
a separate job with NO database service to prove refusal.
"""
